...
<!-- generated with COPASI 4.9.43 (Source) (http://www.copasi.org) at 2013-10-27 12:31:51 UTC -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
  ...
  <Model key="Model_1" name="New Model" simulationType="time" timeUnit="s" volumeUnit="µl" areaUnit="m²" lengthUnit="m" quantityUnit="nmol" type="deterministic" avogadroConstant="6.02214179e+23">
    <ListOfCompartments>
      <Compartment key="Compartment_1" name="cell" simulationType="fixed" dimensionality="3">
      </Compartment>
    </ListOfCompartments>
    <ListOfMetabolites>
      <Metabolite key="Metabolite_1" name="glucose" simulationType="fixed" compartment="Compartment_1">
      </Metabolite>
      <Metabolite key="Metabolite_3" name="glucose-6-phosphate" simulationType="reactions" compartment="Compartment_1">
      </Metabolite>
      <Metabolite key="Metabolite_5" name="ATP" simulationType="fixed" compartment="Compartment_1">
      </Metabolite>
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="hexokinase" reversible="false" fast="false">
        ...
        <ListOfConstants>
          <Constant key="Parameter_114" name="v" value="0.5"/>
        </ListOfConstants>
      ...
      <Reaction key="Reaction_1" name="hexokinase-backwards" reversible="false" fast="false">
        <ListOfSubstrates>
        ...
        <ListOfConstants>
          <Constant key="Parameter_115" name="k1" value="1"/>
        </ListOfConstants>
