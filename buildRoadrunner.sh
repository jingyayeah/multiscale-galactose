...
PY_RR=http://sourceforge.net/projects/libroadrunner/files/libroadrunner-1.3-beta/pylibroadrunner-1.3-symcache-beta2-linux_x86_64.tar.gz/download
...
cd pylibroadrunner-1.3-symcache-beta2-linux_x86_64
