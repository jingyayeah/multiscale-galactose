...
f_d.factory <- function(models, xname, sex='all', age=NA, bodyweight=NA, height=NA, BSA=NA, volLiver=NA){
    if (is.na(get(xname))){
        return(NULL)
    }
    # data to predict
...
# some example values
age<-80; sex<-'male'; bodyweight<-55; BSA<-1.6; height=170; volLiver<-1500
