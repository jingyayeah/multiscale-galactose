...
library(ggplot2)
par(mfrow=c(2,1))
plot(marG2$age, marG2$GEC, type='n', xlim=c(0,100), ylim=c(0,10)) 
...
points(marG2$age[marG2$gender=='male'], marG2$GECkg[marG2$gender=='male'], col='Blue') 
points(marG2$age[marG2$gender=='female'], marG2$GECkg[marG2$gender=='female'], col='Red') 
