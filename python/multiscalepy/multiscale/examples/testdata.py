...
galactose_singlecell_sbml = os.path.join(test_dir, 'models/galactose', 'results/{}_annotated.xml'.format(galactose_id))
galactose_singlecell_sbml_no_annotations = os.path.join(test_dir, 'models/galactose', 'results/{}.xml'.format(galactose_id))
