'''
Definition of distributions for model.

TODO: read the distributions from a parameter file.
     i.e. for every model there is an additional file defining the distributions
     for paramters. If no distribution information is available the underlying
