...
def createFluxDistribution(count_rel, fdListElement, items_dict, model, reactions, species):
    ...
    fluxListElement = et.SubElement(fdElement, FLUX_LIST);
    concentrationListElement = et.SubElement(fdElement, CONCENTRATION_LIST);
    ...
    for key in items_dict.keys():
        ...
        if (reactions.has_key(key)):
            flux = items_dict[key]
            if (flux != 0.0):        
                fluxElement = et.SubElement(fluxListElement, FLUX)
        ...
        if (species.has_key(key)):
            ...
            concentrationElement = et.SubElement(concentrationListElement, CONCENTRATION);
