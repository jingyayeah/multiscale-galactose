...
from multiscale.modelcreator.events.eventdata import createGalactoseChallengeEventData,\
    createRectEventData, createGaussEventData
from multiscale.modelcreator.events.eventdata import createGalactoseStepEventData
...
if __name__ == "__main__":
    ...
    Nf = 1
    version = 128
    cell_model = CellModel.create_model('galactose.GalactoseCell')
