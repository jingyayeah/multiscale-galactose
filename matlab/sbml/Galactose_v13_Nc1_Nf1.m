function xdot = Galactose_v13_Nc1_Nf1(time,x)
%  synopsis:
%     xdot = Galactose_v13_Nc1_Nf1 (time, x)
%     x0 = Galactose_v13_Nc1_Nf1
%
%  Galactose_v13_Nc1_Nf1 can be used with odeN functions as follows:
%
%  x0 = Galactose_v13_Nc1_Nf1;
...
%
%  When Galactose_v13_Nc1_Nf1 is used without any arguments it returns a vector of
%  the initial concentrations of the 26 floating species.
%  Otherwise Galactose_v13_Nc1_Nf1 should be called with two arguments:
%  time and x.  time is the current time. x is the vector of the
%  concentrations of the 26 floating species.
%  When these parameters are supplied Galactose_v13_Nc1_Nf1 returns a vector of 
...
if (nargin == 0)
   ...
   R0 = Function_for_FlowPPS001_gal(g_p12,(g_p149/vol__PP)/vol__PP,g_p5);
   R1 = Function_for_FlowS001PV_gal(g_p12,(x(1)/vol__S001)/vol__S001,g_p5);
   R2 = vol__PV*Function_for_FlowPVNULL_gal(g_p12,vol__PV,(x(3)/vol__PV)/vol__PV,g_p5);
   R3 = Function_for_FlowPPS001_galM(g_p12,(g_p150/vol__PP)/vol__PP,g_p5);
   R4 = Function_for_FlowS001PV_galM(g_p12,(x(4)/vol__S001)/vol__S001,g_p5);
   R5 = vol__PV*Function_for_FlowPVNULL_galM(g_p12,vol__PV,(x(6)/vol__PV)/vol__PV,g_p5);
   R6 = Function_for_FlowPPS001_h2oM(g_p12,(g_p151/vol__PP)/vol__PP,g_p5);
   R7 = Function_for_FlowS001PV_h2oM(g_p12,(x(7)/vol__S001)/vol__S001,g_p5);
   R8 = vol__PV*Function_for_FlowPVNULL_h2oM(g_p12,vol__PV,(x(9)/vol__PV)/vol__PV,g_p5);
   R9 = Function_for_DiffPPS001_gal(g_p21,(g_p149/vol__PP)/vol__PP,(x(1)/vol__S001)/vol__S001);
   R10 = Function_for_DiffS001PV_gal(g_p21,(x(3)/vol__PV)/vol__PV,(x(1)/vol__S001)/vol__S001);
   R11 = Function_for_DiffS001D001_gal((x(2)/vol__D001)/vol__D001,g_p23,(x(1)/vol__S001)/vol__S001);
   R12 = Function_for_DiffPPS001_galM(g_p25,(g_p150/vol__PP)/vol__PP,(x(4)/vol__S001)/vol__S001);
   R13 = Function_for_DiffS001PV_galM(g_p25,(x(6)/vol__PV)/vol__PV,(x(4)/vol__S001)/vol__S001);
   R14 = Function_for_DiffS001D001_galM((x(5)/vol__D001)/vol__D001,g_p27,(x(4)/vol__S001)/vol__S001);
   R15 = Function_for_DiffPPS001_h2oM(g_p29,(g_p151/vol__PP)/vol__PP,(x(7)/vol__S001)/vol__S001);
   R16 = Function_for_DiffS001PV_h2oM(g_p29,(x(9)/vol__PV)/vol__PV,(x(7)/vol__S001)/vol__S001);
   R17 = Function_for_DiffS001D001_h2oM((x(8)/vol__D001)/vol__D001,g_p31,(x(7)/vol__S001)/vol__S001);
   R18 = vol__H01*Function_for_Galactokinase__H01(g_p47,g_p46,g_p41,g_p44,vol__H01,g_p49,g_p50,(x(20)/vol__H01)/vol__H01,(x(19)/vol__H01)/vol__H01,(x(10)/vol__H01)/vol__H01,(x(15)/vol__H01)/vol__H01);
   R19 = vol__H01*Function_for_Galactokinase__H01__2(g_p47,g_p46,g_p44,vol__H01,g_p49,g_p50,(x(19)/vol__H01)/vol__H01,(x(15)/vol__H01)/vol__H01,(x(11)/vol__H01)/vol__H01);
   R20 = vol__H01*Function_for_Inositol_monophosphatase__H01(vol__H01,g_p54,(x(15)/vol__H01)/vol__H01,g_p52);
   R21 = vol__H01*Function_for_ATP_synthase__H01(g_p57,g_p58,g_p59,g_p56,vol__H01,g_p61,(x(20)/vol__H01)/vol__H01,(x(19)/vol__H01)/vol__H01,(x(23)/vol__H01)/vol__H01);
   R22 = vol__H01*Function_for_Aldose_reductase__H01(g_p64,g_p65,g_p66,g_p67,g_p63,vol__H01,g_p69,(x(10)/vol__H01)/vol__H01,(x(18)/vol__H01)/vol__H01,(x(25)/vol__H01)/vol__H01,(x(26)/vol__H01)/vol__H01);
   R23 = vol__H01*Function_for_NADP_Reductase__H01(vol__H01,g_p75,(x(25)/vol__H01)/vol__H01,(x(26)/vol__H01)/vol__H01,g_p72,g_p71,g_p73);
   R24 = vol__H01*Function_for_Galactose_1_phosphate_uridyl_transferase__H01(g_p83,g_p78,g_p79,g_p84,g_p77,g_p81,g_p80,vol__H01,g_p86,(x(15)/vol__H01)/vol__H01,(x(13)/vol__H01)/vol__H01,(x(22)/vol__H01)/vol__H01,(x(17)/vol__H01)/vol__H01,(x(16)/vol__H01)/vol__H01,(x(21)/vol__H01)/vol__H01);
   R25 = vol__H01*Function_for_UDP_glucose_4_epimerase__H01(g_p92,g_p91,g_p90,vol__H01,g_p94,(x(17)/vol__H01)/vol__H01,(x(16)/vol__H01)/vol__H01);
   R26 = vol__H01*Function_for_UDP_glucose_pyrophosphorylase__H01(vol__H01,g_p107,g_p108,(x(13)/vol__H01)/vol__H01,(x(24)/vol__H01)/vol__H01,(x(16)/vol__H01)/vol__H01,(x(21)/vol__H01)/vol__H01,g_p99,g_p98,g_p97);
   R27 = vol__H01*Function_for_UDP_galactose_pyrophosphorylase__H01(vol__H01,g_p107,g_p108,(x(15)/vol__H01)/vol__H01,(x(24)/vol__H01)/vol__H01,(x(17)/vol__H01)/vol__H01,(x(21)/vol__H01)/vol__H01,g_p96,g_p102,g_p98,g_p97);
   R28 = vol__H01*Function_for_Pyrophosphatase__H01(vol__H01,g_p113,(x(24)/vol__H01)/vol__H01,g_p110,g_p111);
   R29 = vol__H01*Function_for_ATP_UDP_phosphotransferase__H01(vol__H01,g_p121,(x(20)/vol__H01)/vol__H01,(x(19)/vol__H01)/vol__H01,(x(22)/vol__H01)/vol__H01,(x(21)/vol__H01)/vol__H01,g_p117,g_p116,g_p119,g_p118,g_p115);
   R30 = vol__H01*Function_for_Phosphoglucomutase_1__H01(vol__H01,g_p127,(x(13)/vol__H01)/vol__H01,(x(14)/vol__H01)/vol__H01,g_p125,g_p124,g_p123);
   R31 = vol__H01*Function_for_Glycolysis__H01(g_p129,g_p130,vol__H01,g_p132,(x(14)/vol__H01)/vol__H01,(x(23)/vol__H01)/vol__H01);
   R32 = vol__H01*Function_for_Glycosyltransferase_galactose__H01(g_p134,vol__H01,g_p137,(x(17)/vol__H01)/vol__H01);
   R33 = vol__H01*Function_for_Glycosyltransferase_glucose__H01(g_p135,vol__H01,g_p137,(x(16)/vol__H01)/vol__H01);
   R34 = Function_for_galactose_transport((x(2)/vol__D001)/vol__D001,g_p139,g_p141,g_p142,(x(10)/vol__H01)/vol__H01,g_p8);
   R35 = Function_for_galactose_transport_2((x(5)/vol__D001)/vol__D001,g_p139,g_p141,g_p142,(x(11)/vol__H01)/vol__H01,g_p8);
   R36 = Function_for_H2O_M_transport((x(8)/vol__D001)/vol__D001,g_p145,(x(12)/vol__H01)/vol__H01,g_p144,g_p8);
