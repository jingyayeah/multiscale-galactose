...
%
%   Matthias Koenig (2013-09-18)
%   Copyright © Matthias König 2013 All Rights Reserved.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The scaling has to be done with the numbers of cells in the sinusoid;
% The more cells -> the smaller the capacity per cell (this is achieved, 
% via the volume of the cell;
Nf = p.Nf;
...
if nargout > 1
    ...
    pi_tot = 3*atp + 2*adp + 3*utp + 2*udp + phos + 2*ppi + glc1p + glc6p + gal1p + 2*udpglc + 2*udpgal;
