function [p] = init_cell(p)
% Generates the initial concentration vector for the given layout.
%   author:     Matthias Koenig & Nikolaus Berndt
%   date:       121017
%   version:    5.1

% initial concentrations
[p.x_names, p.x_init] = pars_cell();
p.Nx_out = 3;                                         % external concentrations (glc, lac, o2)

p.Nx_in  = numel(p.x_names) - p.Nx_out;               % internal concentrations
